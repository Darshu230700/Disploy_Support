...
import { EmployeeLogDate, createImageFromInitials } from '../Common/Common';
const color = "#e4aa07";
const EmployeeLogs = ({ allReportData, debouncedOnChange, exportDataToCSV, loading }) => {
                                                ...
                                                <tr className="border-b border-gray-200 bg-white" key={item?.ticketID}>
                                                    ...
                                                    <td className="px-5 py-3 text-lg">
                                                        <div className="flex items-center gap-3">
                                                            ...
                                                            <span className="text-gray-600 whitespace-no-wrap">{item?.employeeName}</span>
                                                        </div>
                                                    </td>

                                                    <td className="px-5 py-3 text-lg">
                                                        {EmployeeLogDate(item?.createdDate)}
                                                    </td>
                                                    <td className="px-5 py-3 text-lg">
                                                        <p className="text-gray-900 whitespace-no-wrap">{item?.lastUpdated}</p>
                                                    </td>
                                                    <td className="px-5 py-3 text-lg">
                                                        <p className="text-gray-900 whitespace-no-wrap">{item?.logs}</p>
                                                    </td>
                                                </tr>
                                            )
                                        })
