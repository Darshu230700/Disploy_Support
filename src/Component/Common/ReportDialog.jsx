...
import yearArray, { reportformatDate, totalMonths } from './Common';
                        ...
                        <div className='p-6'>
                            <div className="grid grid-rows-3 grid-flow-col gap-4 mb-4">
                                ...
                                <div className='grid grid-rows-subgrid gap-4 row-span-2'>
                                    <div className='flex row-start-2 flex-col'>
                                        <select
                                            id="country"
                                            className="relative border border-black rounded-lg p-3 w-full"
                                            disabled={selectedOption !== "monthly"}
                            ...
                            <div className="flex items-center justify-center p-2 md:p-2 border-t border-gray-200 rounded-b dark:border-gray-600 gap-2">
                                ...
                                <button
                                    className="bg-primary w-32 text-white text-base px-8 py-3 border border-primary shadow-md rounded-full "
                                    type="button"
                                    onClick={onSubmit}
                                >
                                    Continue
