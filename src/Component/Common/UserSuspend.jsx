...
const UserSuspend = ({ HandleClose, handleSuspend }) => {
    return (
        <>
            <div
                id="popup-modal"
                ...
                <div className="relative p-4 w-full max-w-md max-h-full">
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div className="p-7 md:p-8 text-center">
                            <FaUserLock className='mx-auto mb-4 text-red-600 w-24 h-24 bg-rose-200 dark:text-gray-200 border rounded-full p-5' />
